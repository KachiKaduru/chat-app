...
export default function SendMessage({ conversationId = "" }) {
  return (
    <form
      action={sendMessage}
      className="w-full flex border-t pt-2 outline-purple-400 items-center px-2 gap-4"
    >
      <PaperClipIcon className="size-5" />
      <div className="border-1 rounded-md border-gray-400 p-3 w-full flex justify-between items-center">
        <input
          type="text"
          name="content"
