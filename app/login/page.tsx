    ...
    <div className="min-h-screen bg-gradient-to-br from-[#1f1c2c] to-[#928dab] flex items-center justify-center p-6">
      <div className="max-w-md w-full bg-[#2d2a3a]/90 backdrop-blur-sm rounded-xl shadow-2xl p-8 space-y-6">
        <div className="text-center space-y-2">
          ...
          <p className="text-[#d1d1d1]">Login to continue to ChatSphere</p>
        </div>

        <form action={loginWithGoogle} className="space-y-4">
          <button
            type="submit"
            className="w-full flex items-center justify-center gap-2 bg-white/10 hover:bg-white/20 border border-white/20 text-white font-medium py-3 px-4 rounded-lg transition-all"
          >
        ...
        <div className="text-center text-sm text-[#d1d1d1]">
          ...
          <Link href="/signup" className="text-[#928dab] hover:underline font-medium">
            Sign up
          </Link>
        </div>
      </div>
